...
exports.GameModule = GameModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            auth_module_1.AuthModule, typeorm_1.TypeOrmModule.forFeature([User_entity_1.User, Profile_entity_1.Profile, Relation_entity_1.Relation, Achievement_entity_1.Achievement, History_entity_1.HistoryEntity, chat_room_entity_1.ChatRoom, chat_room_users_entity_1.ChatRoomUser, message_entity_1.Message, chat_entity_1.Chat])
        ],
        providers: [game_gateway_1.GameGateway, game_service_1.GameService, pong_game_1.PongGame],
    })
], GameModule);
