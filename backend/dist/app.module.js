...
const user_status_module_1 = require("./user-status/user-status.module");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [User_entity_1.User, Profile_entity_1.Profile, Relation_entity_1.Relation, Achievement_entity_1.Achievement, History_entity_1.HistoryEntity, chat_room_entity_1.ChatRoom, chat_room_users_entity_1.ChatRoomUser, message_entity_1.Message, chat_entity_1.Chat],
            ...
            chat_module_1.ChatModule, game_module_1.GameModule, user_status_module_1.UserStatusModule,
        ],
