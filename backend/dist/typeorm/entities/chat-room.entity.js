...
], ChatRoom.prototype, "RoomId", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], ChatRoom.prototype, "picture", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => message_entity_1.Message, message => message.chatRoom),
    __metadata("design:type", Array)
], ChatRoom.prototype, "messages", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => chat_room_users_entity_1.ChatRoomUser, chatRoomUser => chatRoomUser.chatRooms),
    (0, typeorm_1.JoinColumn)({ name: 'chatRoomUserId' }),
    __metadata("design:type", chat_room_users_entity_1.ChatRoomUser)
], ChatRoom.prototype, "chatRoomUser", void 0);
